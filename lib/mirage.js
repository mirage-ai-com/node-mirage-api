...
Mirage.prototype.__doPostData = function(
  ...
  restler.postJson(
    this.__getRESTURL(resource), data,
      this.__getRequestOptions(options.requestID)
  )
...
Mirage.prototype.__doPostStream = function(
  ...
  var request = restler.postJson(
    this.__getRESTURL(resource, true), data,
      this.__getRequestOptions(options.requestID, true)
  );
 ...
 */
Mirage.prototype.__getRequestOptions = function(requestID, stream) {
  ...
  if (requestID !== null) {
    // Stamp request with provided request identifier (this is optional, but \
